...
exports.default = async function makeAnnotatedExecutableSchema(annotatedSchema) {
    var remoteSchemaAnnotations = (0, _schemaAnnotationExtractor.extractSchemaAnnotations)(annotatedSchema);
    var remoteSchemaPromises = remoteSchemaAnnotations.map(toRemoteSchemas);
    var remoteSchemas = await Promise.all(remoteSchemaPromises);
